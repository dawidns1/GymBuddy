...
class TemplateView : FrameLayout {
    ...
    private var callToActionView: ImageButton? = null
    var realLayout: ConstraintLayout? = null
        private set
    var mockLayout: ShimmerFrameLayout? = null
        private set
    ...
    private fun applyStyles() {
        ...
        if (mainBackground != null) {
            realLayout!!.background = mainBackground
            if (primaryView != null) {
...
//        tertiaryView = findViewById<View>(R.id.body) as TextView
        ...
        callToActionView = findViewById<View>(R.id.cta) as ImageButton
        iconView = findViewById<View>(R.id.icon) as ImageView
//        mediaView = findViewById<View>(R.id.media_view) as MediaView
        realLayout = findViewById<View>(R.id.background) as ConstraintLayout
        realLayout!!.visibility = GONE
        mockLayout = findViewById(R.id.mock_layout)
        mockLayout?.visibility = VISIBLE
        mockLayout?.startShimmer()
    }
