...
import com.example.gymbuddy.helpers.NativeTemplateStyle;
...
public class TemplateView extends FrameLayout {
  ...
  private ImageButton callToActionView;
  private ConstraintLayout background;
  private ShimmerFrameLayout mockLayout;

  public ConstraintLayout getRealLayout(){
    return background;
  }

  public ShimmerFrameLayout getMockLayout(){
    return mockLayout;
  }
...
//  Set the secondary view to be the star rating if available.
  ...
  public void onFinishInflate() {
    ...
    callToActionView = (ImageButton) findViewById(R.id.cta);
    ...
    mockLayout.setVisibility(VISIBLE);
